...
public class YoungesMaletEmployeeInProductDev {
    public static Optional<Employee1> getYoungestMAleEmployeeInProductionDev(List<Employee1> employees){
        return employees.stream().filter(e->e.getDepartment()=="Product Development" && e.getGender()=="Male").min(Comparator.comparing(Employee1::getAge));
    }
    public static void main(String[] args) {
        ...
        System.out.println(getYoungestMAleEmployeeInProductionDev(employeeList));
    }

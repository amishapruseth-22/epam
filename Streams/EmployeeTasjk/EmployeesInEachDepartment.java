...
public class EmployeesInEachDepartment {
    public static Map<String,Long> getEmployeesByDepartment(List<Employee1> employees){
        return employees.stream().collect(Collectors.groupingBy(Employee1::getDepartment, Collectors.counting()));
    }

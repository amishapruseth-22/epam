...
public class AverageSalaryOfMaleAndFemale {
    public static Map<String,Double> calculateAverageSalaryByGender(List<Employee1> employees){
        return employees.stream().collect(Collectors.groupingBy(Employee1::getGender,Collectors.averagingDouble(Employee1::getSalary)));
    }
    public static void main(String[] args) {
        ...
        System.out.println(calculateAverageSalaryByGender(employeeList));
    }
}

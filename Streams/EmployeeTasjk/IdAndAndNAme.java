...
public class IdAndAndNAme {
    public static Map<Integer,String> returnIdAndName(List<Employee1> employees){
        return employees.stream().collect(Collectors.toMap(Employee1::getId,Employee1::getName));
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(returnIdAndName(employeeList));
    }
}

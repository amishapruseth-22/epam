...
public class EmployeesYoungerThan25 {
    public static Map<Boolean,Long> getEmployeesYoungerandOlderThan25(List<Employee1> employees) {
        return employees.stream().collect(Collectors.partitioningBy(e->e.getAge()<=25,Collectors.counting()));
    }
    public static void main(String[] args) {
        ...
        System.out.println(getEmployeesYoungerandOlderThan25(employeeList));
    }
}

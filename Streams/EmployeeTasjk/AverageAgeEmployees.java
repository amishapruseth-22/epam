...
public class AverageAgeEmployees {
    public static Map<String,Double> averageAgeByType(List<Employee1> employees) {
        return employees.stream().collect(Collectors.groupingBy(Employee1::getGender, Collectors.averagingDouble(Employee1::getAge)));
    }
    public static void main(String[] args) {
        ...
        System.out.println(averageAgeByType(employeeList));
    }

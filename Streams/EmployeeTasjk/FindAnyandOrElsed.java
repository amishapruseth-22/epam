...
public class FindAnyandOrElsed {
    public static Employee1 getEmployeeSalaryLessThan5000(List<Employee1> employees){
        return employees.stream().filter(e->e.getSalary()<5000).findAny()
                .orElse(new Employee1(20,"ABC",20,"Male","IT",2012,5000));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getEmployeeSalaryLessThan5000(employeeList));
    }
}

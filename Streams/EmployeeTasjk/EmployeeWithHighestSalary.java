...
public class EmployeeWithHighestSalary {
    public static Optional<Employee1> findEmployeeWithHighestSalary(List<Employee1> employees){
       return employees.stream().max(Comparator.comparing(Employee1::getSalary));
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(findEmployeeWithHighestSalary(employeeList));

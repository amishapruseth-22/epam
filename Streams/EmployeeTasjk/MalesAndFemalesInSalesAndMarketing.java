...
public class MalesAndFemalesInSalesAndMarketing {
    public static Map<String,Long> getMalesAndFemalesInSalesAndMarketing(List<Employee1> employees){
        return employees.stream().filter(e->e.getDepartment().equalsIgnoreCase("Sales And MArketing")).
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getMalesAndFemalesInSalesAndMarketing(employeeList));
    }
}

...
public class Departments {
    public static List<String> printDepartments(List<Employee1> employees){
        return employees.stream().map(Employee1::getDepartment).distinct().toList();
    }
    public static void main(String[] args) {
        ...
        System.out.println(printDepartments(employeeList));
    }
}

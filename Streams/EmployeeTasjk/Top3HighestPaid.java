...
public class Top3HighestPaid {
    public static List<Employee1> top3HighestPaid(List<Employee1> employees){
        return employees.stream().sorted(Comparator.comparingDouble(Employee1::getSalary).reversed()).limit(3).toList();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(top3HighestPaid(employeeList));
    }
}

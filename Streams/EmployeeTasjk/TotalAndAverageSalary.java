...
public class TotalAndAverageSalary {
    public static double calculateTotalSalary(List<Employee1> employees){
        DoubleSummaryStatistics statistics=employees.stream().collect(Collectors.summarizingDouble(Employee1::getSalary));
        return statistics.getSum();
    }
    public static double calculateAverageDouble(List<Employee1> employees){
        DoubleSummaryStatistics statistics=employees.stream().collect(Collectors.summarizingDouble(Employee1::getSalary));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(calculateAverageDouble(employeeList));
    }
}

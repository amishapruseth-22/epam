...
public class MostWorkingExperience {
    public static Optional<Employee1> getMostWorkingExperienceEmployee(List<Employee1> employees){
        return employees.stream().min(Comparator.comparing(Employee1::getYearOfJoining));
    }
    public static void main(String[] args) {
        ...
        System.out.println(getMostWorkingExperienceEmployee(employeeList));
    }
}

...
public class RemoveDuplicatesBasedOnNAmeAndDepartment {
    public static List<Employee1> removeDuplicate(List<Employee1> employees){
        return employees.stream().collect(Collectors.collectingAndThen(Collectors.toCollection(()-> new TreeSet<>
                (Comparator.comparing(e->e.getDepartment()+"-"+e.getName()))), collection-> new ArrayList<>(collection)));
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(removeDuplicate(employeeList));
    }
}

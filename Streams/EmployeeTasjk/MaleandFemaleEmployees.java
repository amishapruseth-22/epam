...
public class MaleandFemaleEmployees {
    public static Map<String,Long> countMaleandFemaleEmployees(List<Employee1> employees){
        return employees.stream().collect(Collectors.groupingBy(Employee1::getGender,Collectors.counting()));
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(countMaleandFemaleEmployees(employeeList));
    }
}

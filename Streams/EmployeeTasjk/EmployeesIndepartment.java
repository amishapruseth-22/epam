...
public class EmployeesIndepartment {
    public static Map<String, List<String>> getEmployeesByDepartment(List<Employee1> employees){
        return employees.stream().collect(Collectors.groupingBy(Employee1::getDepartment,Collectors.mapping(Employee1::getName,Collectors.toList())));
    }
    public static void main(String[] args) {
        ...
        System.out.println(getEmployeesByDepartment(employeeList));
    }
}

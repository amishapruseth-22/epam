...
public class EmployeeNwamesAfter2015 {
    public static List<String> getNamesAfter2015(List<Employee1> employees){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getNamesAfter2015(employeeList));
    }
}

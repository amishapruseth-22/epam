...
public class AgeAndDepartmentOfOldestEmployee {
    public static Map<Integer,String> getOldestEmployeeAgeAndDepartment(List<Employee1> employees){
        Optional<Employee1> employee1= employees.stream().max(Comparator.comparing(Employee1::getAge));
//        return employee1.map(emp -> Map.of(emp.getAge(), emp.getDepartment()))
//                .orElseGet(() -> Map.of());
        return employee1.map(emp->Map.of(emp.getAge(),emp.getDepartment())).orElse(Map.of());
    }
    public static void main(String[] args) {
        ...
        System.out.println(getOldestEmployeeAgeAndDepartment(employeeList));
    }
}

...
public class EarningMoreThan20000 {
    public static  String employeesEarningMoreThan20000(List<Employee1> employees){
        return employees.stream().filter(e->e.getSalary()>20000).map(Employee1::getName).collect(Collectors.joining(","));
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(employeesEarningMoreThan20000(employeeList));
    }
}
